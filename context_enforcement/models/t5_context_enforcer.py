        ...
        if encoder_outputs is None:
            ...
            if attention_mask is not None:
                batch_attention = attention_mask[
                    :, context_boundary[0] : context_boundary[1]
                ]
            ...
            encoder_outputs = EncoderOutputs(
                ...
                context_boundary=encoder_outputs[5]
                if len(encoder_outputs) > 5
                else context_boundary,
                cleaned_mask=encoder_outputs[6]
                if len(encoder_outputs) > 6
                else batch_attention,
            )
