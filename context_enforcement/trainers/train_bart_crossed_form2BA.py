...
from context_enforcement.models.bart_context_enforcer_original_self import (
...
if __name__ == "__main__":
    ...
    os.makedirs(train_args_path,exist_ok=True)
    pk.dump(
        arguments,
        open(os.path.join(train_args_path, "train_args.ap"), "wb"),
    )
